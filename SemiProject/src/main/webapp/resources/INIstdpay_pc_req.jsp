                ...
                <div class="card">
                    ...
                    <form name="" id="SendPayForm_id" method="post" class="mt-5">
                        <div class="row g-3 justify-content-between" style="--bs-gutter-x:0rem;">
                            ...
                            <label class="col-10 col-sm-2 input param" style="border:none; display: none;">지불수단</label>
                            <label class="col-10 col-sm-9 input" style=" display: none;">
                                <input type="text" name="gopaymethod" value="Card:Directbank:vbank"">
                            </label>
				    		
				    		<label class="col-10 col-sm-2 input param" style="border:none;">프로젝트명</label>
                            <label class="col-10 col-sm-9 input">
                                <input type="text" name="mid" value="<%=mid%>">
                            </label>
				    
                            <label class="col-10 col-sm-2 input param" style="border:none;">주문번호</label>
                            <label class="col-10 col-sm-9 input">
                                <input type="text" name="oid" value="<%=orderNumber%>">
                            </label>
				    		
				    		<label class="col-10 col-sm-2 input param" style="border:none;">결제금액</label>
                            <label class="col-10 col-sm-9 input">
                                <input type="text" name="price" value="<%=price%>">
                            </label>
				    		
				    		<label class="col-10 col-sm-2 input param" style="border:none; display: none;">timestamp</label>
                            <label class="col-10 col-sm-9 input" style="display: none;">
				    		...
				    		<label class="col-10 col-sm-2 input param" style="border:none;">병원예약금액</label>
                            <label class="col-10 col-sm-9 input">
                                <input type="text" name="goodname" value="money">
                            </label>
				    		
				    		<label class="col-10 col-sm-2 input param" style="border:none;">보호자명</label>
                            <label class="col-10 col-sm-9 input">
                                <input type="text" name="buyername" value="name">
                            </label>
				    		
				    		<label class="col-10 col-sm-2 input param" style="border:none;">전화번호</label>
                            <label class="col-10 col-sm-9 input">
                                <input type="text" name="buyertel" value="tel">
                            </label>
				    		
				    		<label class="col-10 col-sm-2 input param" style="border:none;">이메일</label>
                            <label class="col-10 col-sm-9 input">
