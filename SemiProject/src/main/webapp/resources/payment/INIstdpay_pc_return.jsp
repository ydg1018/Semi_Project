...
<!--                     </div> -->
                    ...
                    <div class="row g-3 justify-content-between" style="--bs-gutter-x:0rem;">
						...
						<label class="col-10 col-sm-2 input param" style="border:none;">병원 주소</label>
                        <label class="col-10 col-sm-9 reinput">
                           병원 주소
                        </label>
						
						<label class="col-10 col-sm-2 input param" style="border:none;">병원 전화번호</label>
                        <label class="col-10 col-sm-9 reinput">
                           병원 전화번호
                        </label>
						...
						<label class="col-10 col-sm-2 input param" style="border:none;">예약 시간</label>
                        <label class="col-10 col-sm-9 reinput">
                            예약 시간
                        </label>
						
						<label class="col-10 col-sm-2 input param" style="border:none;">진료 내용</label>
                        <label class="col-10 col-sm-9 reinput">
                            진료 내용
                        </label>
